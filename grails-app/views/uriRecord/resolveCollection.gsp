...
%{--            <div style="text-align:center; color:#e33e3e; font-weight:bold;">
                ${requestedUri} <g:if test="${obsolete}"><span style="color:#feba12; font-weight:bold; padding-left:1em;">[<img src="${resource(dir: 'images', file: 'warning.gif', base: 'http://static.identifiers.org/')}" alt="Warning icon" title="The requested URI is deprecated, please use the official one instead: ${record.officialUrl()}" style="vertical-align: top; margin-top: 2px; padding-right: 3px;" /> <a href="${record.officialUrl()}" title="The requested URI is deprecated, please use the official one instead: ${record.officialUrl()}" class="warning_link">Official URL</a>]</span></g:if>
            </div>--}%
        ...
        <div class="close_button">
                <a href="http://www.ebi.ac.uk/miriam/main/datatypes/${record.id}" title="Close this top bar">Close</a> <a href="http://www.ebi.ac.uk/miriam/main/datatypes/${record.id}" title="Close this top bar"><img src="${resource(dir: 'images', file: 'red_cross.gif', base: 'http://static.identifiers.org/')}" alt="Closing icon" title="Close this top bar" style="vertical-align: middle;" /></a>
            </div>
        </div>
