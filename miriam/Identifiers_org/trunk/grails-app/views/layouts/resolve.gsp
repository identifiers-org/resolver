...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<link rel="stylesheet" href="${resource(dir: 'css', file: 'resolve.css', base: 'http://dev.static.identifiers.org/')}" type="text/css" />
        <script type="text/javascript" src="${resource(dir: 'js', file: 'jquery-1.8.0.min.js', base: 'http://static.identifiers.org/')}"></script>
        <script type="text/javascript" src="${resource(dir: 'js', file: 'resolver.js', base: 'http://dev.static.identifiers.org/')}"></script>
