...
<html>
    ...
    <body>
        <div style="position:fixed; top:0px; left:0px; height:50px; width:100%; background-color:#EEF5F5; border-top: 1px solid #e33e3e; border-bottom: 1px solid #e33e3e; padding-left:5px;">
        ...
        <div style="height:100%; margin-top:52px;">
