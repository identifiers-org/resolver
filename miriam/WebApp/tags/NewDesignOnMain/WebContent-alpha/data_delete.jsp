...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<div id="content">
			...
			<h2><span class="box_green">Delete</span> data-type(s)</h2>
			
			<p>
				You asked for removing these data-types:
			</p>
			
			<ul>
				<c:forEach items="${data}" var="elt">
					<li>${elt}</li>
				</c:forEach>
			</ul>
			
			<p>
				An email has been sent to the administrator. Normally, the deletion should be done soon. Thank you for your support.
			</p>
