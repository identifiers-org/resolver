 ...
 * <p>
 * Link to the function: getDataTypeSynonyms
 * 
 * <p>
 * <dl>
 * <dt><b>Copyright:</b></dt>
 ...
 * @version 20060802
 */
public class ServletGetDataTypeSynonyms extends BaseAjaxServlet
{
	private static final long serialVersionUID = 8745497189201085184L;
	...
	public String getXmlContent(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		String name = request.getParameter("getDataTypeSynonymsParam");
	    ...
	    String[] result = mir.getDataTypeSynonymsAnswer(name);
