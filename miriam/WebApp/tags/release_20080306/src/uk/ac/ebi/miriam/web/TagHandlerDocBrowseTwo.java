...
public class TagHandlerDocBrowseTwo extends SimpleTagSupport
{
  ...
  private ArrayList<String> urls;   /* list of physical address */
  private ArrayList<String> infos;   /* information */
  private ArrayList<String> institutions;   /* institutions */
  private ArrayList<String> locations;   /* location (country) */
