 ...
 * <p>
 * TODO:
 *   - remove the URLs hard coded ("http://www.pubmed.gov/" or "http://www.doi.org/") and replace them with a database access
 *
 * <p>
 * <dl>
 * <dt><b>Copyright:</b></dt>
            ...
            if (data.isExisting(poolName, false))
            {
                ...
                if (data.hasOfficialResource())
                {
                    ...
                    else   // the user is anonymous
                    {
                        ...
                        // sends an email to the administrator with the OLD information about the data-type
                        emailBody = "\nThe data-type '" + data.getId() + "' needs to be updated [" + version + " version], here are the information previously stored:";
                        emailBody += oldOne.toString();
