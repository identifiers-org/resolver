 ...
 * @version 20060802
 */
public class ServletGetName extends BaseAjaxServlet
{
  private static final long serialVersionUID = -366465926906778989L;
  ...
  public String getXmlContent(HttpServletRequest request, HttpServletResponse response) throws Exception
  {
    ...
    String uri = request.getParameter("getNameParam");
    ...
    // processing the request
      ...
      String result = mir.getNameAnswer(uri);
