					...
					<c:if test="${data.obsolete == true}">
                        ...
                        <div class="message_display">
                            <div class="xround"><b class="xtop"><b class="xb1">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb4">&nbsp;</b></b><div class="xboxcontent">
                                WARNING! We recommend the usage of the following data type instead: <a href="mdb?section=browse&amp;data=${data.replacedBy}" title="Go to ${data.replacedBy}">${data.replacedBy}</a>.
                                <br />
					...
					<table class="datatyperesult" summary="data resource information">
						...
						<mir:resourcesBrowse data="${data.resources}">
							<tr>
								...
								<td class="element">${prefix}<b><acronym class="idInfo" title="This identifier follows the pattern: ${data.regexp}">$id</acronym></b>${suffix}<c:if test="${! empty example}">&nbsp;&nbsp;[Example:&nbsp;<a href="${prefix}${example}${suffix}" title="Example of entity stored by this resource">${example}</a>]</c:if></td>
							</tr>
							<tr>
