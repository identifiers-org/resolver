				...
				<td class="contentsarea" id="contentsarea">
					...
					<p>
						<c:choose>
							...
							<%-- anonymous user  --%>
							<c:otherwise>
								You are an anonymous user: the data type will not be updated directly in MIRIAM Database after you pressed the <b>Update</b> button, there will be a human checking process before.
							</c:otherwise>
						</c:choose>
					</p>
					...
					<form method="post" id="submission_form" action="dataTypeEditPart2" onsubmit="return validate_submission();">
						...
						<c:if test="${sessionScope.login == null}">
							...
							<div class="help_submission" id="HelpUser" style="display: none;">
								<div class="xround"><b class="xtop"><b class="xb1">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb4">&nbsp;</b></b><div class="xboxcontent">
									<p>
										You can enter in this field your name, group, institution, and any other information in order to explain why you would like to update this data type in MIRIAM Resources.
									</p>
								</div><b class="xbottom"><b class="xb4">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb1">&nbsp;</b></b></div>
							</div>
						</c:if>
