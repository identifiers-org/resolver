<%--
  ...
  MIRIAM Web Interface,
    'view' part of the application: displays the result of a search (only the id, name and definition of the retrieved data types).
        ...
        <table class="contentspane" id="contentspane" summary="The main content pane of the page" style="width: 100%">
            <tr>
	            ...
	            <td class="contentsarea" id="contentsarea">
                    ...
                    <p>
                        Here are the data types returned by your search for <b>${words}</b>:
                    </p>
                    ...
                    <c:if test="${!empty data}">
	                    <table class="sqlresult" summary="search results table">
		                    ...
		                    <mir:searchBrowse data="${data}">
		                        <tr class="${class}">
		                            <td class="${class}"><a href="mdb?section=browse&amp;data=${id}" title="Access to the complete information about the data type: ${name}">${name}</a></td><td class="${class}">${def}</td>
		                        </tr>
		                    </mir:searchBrowse>
	                    </table>
                    </c:if>
                    ...
                    <p>
                        ${counter} item<c:if test="${counter > 1}">s</c:if> returned.
                    </p>
