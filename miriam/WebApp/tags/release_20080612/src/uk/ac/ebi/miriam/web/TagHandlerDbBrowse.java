...
public class TagHandlerDbBrowse extends SimpleTagSupport
{
    ...
    private ArrayList<List<String>> data;   // SQLResult
     ...
     */
    public void setData(ArrayList<List<String>> data)   // SQLResult
    {
        this.data = data;
    }
    ...
    public void doTag() throws JspException, IOException
    {
        ...
        for (int j=0; j<((ArrayList<String>) data.get(1)).size(); ++j)
        {
            if (j % 2 == 0)
            {
            ...
            context.setAttribute("id", (String) ((ArrayList<String>) data.get(0)).get(j));
            context.setAttribute("name", (String) ((ArrayList<String>) data.get(1)).get(j));
            context.setAttribute("uri", (String) ((ArrayList<String>) data.get(2)).get(j));
            context.setAttribute("definition", (String) ((ArrayList<String>) data.get(3)).get(j));
