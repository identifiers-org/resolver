    ...
    <table class="contentspane" id="contentspane" summary="The main content pane of the page" style="width: 100%">
      <tr>
		...
		<form method="post" id="submission_form" action="addDataType" onsubmit="return validate_submission();">
			...
			<p>
				Here is some information about the data-type: definition and regular expression (<i>i.e.</i> pattern for identifiers of elements).
			</p>
			...
			<c:if test="${sessionScope.login == null}">
				...
				<div class="help_submission" id="HelpUser" style="display: none;">
					<div class="xround"><b class="xtop"><b class="xb1">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb4">&nbsp;</b></b><div class="xboxcontent">
						<p>
							You can enter in this field your name, group, institution, and any other information in order to explain why you would like to add this data type to MIRIAM Resources. You can as well give some suggested tags for this data type (cf. <a href="mdb?section=metadata" title="List of tags">list of tags currently used</a>).
						</p>
					</div><b class="xbottom"><b class="xb4">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb1">&nbsp;</b></b></div>
				</div>
			</c:if>
