...
public class DataType
{
	...
	/* date of creation fo the data-type (the Date and String versions are linked and are modified together) */
	...
	private String dateModificationStr = new String();   // for direct display in JSP following the good pattern
