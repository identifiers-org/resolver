...
/**
 * <p>
 * Servlet that handles the queries to the database for accessing the complete information about a data-type
 *
 * <p>
 * <dl>
 * <dt><b>Copyright:</b></dt>
...
/*
      if (data.getDeprecatedURIs().isEmpty())
      {
        ArrayList temp = new ArrayList();
        temp.add("<i>No element</i>");
