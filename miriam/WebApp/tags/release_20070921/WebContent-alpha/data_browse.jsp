      ...
      <tr>
        ...
        <td class="contentsarea" id="contentsarea">
          ...
          <h1>MIRIAM - Alpha</h1>
					...
					<h2>Data-type: <em>${data.name}</em>&nbsp;<a href="mdb?section=edit&amp;data=${data.id}" title="Edit the following data-type: ${data.name}"><img src="${initParam.www}img/Edit.gif" alt="Edit icon" align="bottom" /></a>
					</h2>
