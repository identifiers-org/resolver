		...
		<form method="post" id="submission_form" action="dataTypeEditPart2" onsubmit="return validate_submission();">
				...
				<div id="doc_id">
					<c:forEach var="url" items="${data.documentationURLs}" varStatus="id">
						<div class="docSubmitForm" id="docSubmitForm${id.count}">
							<div>
								<a href="javascript:;" title="Remove this piece of documentation" onclick="removeDoc('docSubmitForm${id.count}')"><img src="${initParam.www}img/Delete.gif" alt="Delete logo" height="16" width="16" /></a>&nbsp;<span id="docTypeBox${id.count}">Type: MIRIAM URI: <input name="docType${id.count}" value="MIRIAM" onclick="return displayMiriamForm('docForm${id.count}', ${id.count});" type="radio" />Physical URL: <input name="docType${id.count}" value="URL" checked="checked" onclick="return displayUrlForm('docForm${id.count}', ${id.count});" type="radio" /></span>
							</div>
					...
					<c:forEach var="uri" items="${data.documentationIDs}" varStatus="uriCount">
						<c:set var="id" value="${docsCounter + uriCount.count}" />
							<div class="docSubmitForm" id="docSubmitForm${id}">
								<div>
									<a href="javascript:;" title="Remove this piece of documentation" onclick="removeDoc('docSubmitForm${id}')"><img src="${initParam.www}img/Delete.gif" alt="Delete logo" height="16" width="16" /></a>&nbsp;<span id="docTypeBox${id}">Type: MIRIAM URI: <input name="docType${id}" value="MIRIAM" checked="checked" onclick="return displayMiriamForm('docForm${id}', ${id});" type="radio" />Physical URL: <input name="docType${id}" value="URL" onclick="return displayUrlForm('docForm${id}', ${id});" type="radio" /></span>
								</div>
			...
			<div class="help_submission" id="HelpDocumentation" style="display: none;">
				<div class="xround"><b class="xtop"><b class="xb1">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb4">&nbsp;</b></b><div class="xboxcontent">
					...
					<p>
						If you choose to add one, you can enter a full physical address (URL) or just its MIRIAM URI (including the Pubmed ID).
					</p>
					<p>
