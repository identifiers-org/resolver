...
function addDoc()
{
	...
	newdiv.innerHTML = "\n<div><a href=\"javascript:;\" title=\"Remove this piece of documentation\" onclick=\"removeDoc(\'" + IdName + "\')\"><img src=\"http://www.ebi.ac.uk/compneur-srv/miriam/alpha/img/Delete.gif\" alt=\"Delete logo\" height=\"16\" width=\"16\" /></a>&nbsp;<span id=\"docTypeBox" + num + "\">Type: MIRIAM URI: <input type=\"radio\" name=\"docType" + num + "\" value=\"MIRIAM\" onclick=\" return displayMiriamForm('docForm" + num + "', " + num + ");\" />Physical URL: <input type=\"radio\" name=\"docType" + num + "\" value=\"URL\" onclick=\"return displayUrlForm('docForm" + num + "', " + num + ");\" /></span></div><div id=\"docForm" + num + "\" class=\"indentDiv\"><em>First, select a type of documentation...</em></div>\n";
