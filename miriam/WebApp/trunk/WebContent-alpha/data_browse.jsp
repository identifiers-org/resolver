		...
		<table class="contentspane" id="contentspane" summary="The main content pane of the page" style="width: 100%">
			<tr>
				...
				<td class="contentsarea" id="contentsarea">
					...
					<h2>Data type: <em>${data.name}</em></h2>
					...
					<c:if test="${data.obsolete == true}">
                        ...
                        <div class="message_display">
                            <div class="xround"><b class="xtop"><b class="xb1">&nbsp;</b><b class="xb2">&nbsp;</b><b class="xb3">&nbsp;</b><b class="xb4">&nbsp;</b></b><div class="xboxcontent">
                                WARNING! We recommend the usage of the following data type instead: <a href="mdb?section=browse&amp;data=${data.replacedBy}" title="Go to ${replacementName}">${replacementName}</a>.
                                <br />
                                Why? ${data.obsoleteComment}
					...
					<div class="tabmenu">
                        <ul id="tabmenu_ul">
                            <li class="current" id="current"><a href="mdb?section=browse&amp;data=${data.id}">General</a></li>
                            <li><a href="mdb?section=tags&amp;data=${data.id}">Tags</a></li>
                            <li><a href="mdb?section=annotation&amp;data=${data.id}">Annotation</a></li>
                        </ul>
                    </div>
					...
					<table class="datatyperesult" summary="data resource information">
						...
						<mir:resourcesBrowse data="${data.resources}">
							<tr>
								...
								<td class="element">${prefix}<b><acronym class="idInfo" title="This identifier follows the pattern: ${data.regexp}">$id</acronym></b>${suffix}<c:if test="${! empty example}">&nbsp;&nbsp;[Example:&nbsp;<a class="external" href="#" onclick="openPopup('${prefix}${example}${suffix}');return false;" title="Example of entity stored by this resource">${example}</a>]</c:if></td>
							</tr>
							<tr>
					...
					<table width="100%" summary="table bottom links">
						<tr>
							...
							<td align="right">
							     <a href="mdb?section=edit&amp;data=${data.id}" title="Edit the following data type: ${data.name}"><img src="${initParam.www}img/Edit.gif" alt="Edit icon" align="bottom" />&nbsp;Edit this data type</a>
                                <!--
