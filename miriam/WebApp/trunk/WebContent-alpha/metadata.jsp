        ...
        <table class="contentspane" id="contentspane" summary="The main content pane of the page" style="width: 100%">
            <tr>
                ...
                <td class="contentsarea" id="contentsarea">
                    ...
                    <p>
                        Here are the list of tags currently used to label the data types.
                    </p>
                    
                    <form method="post" action="tagSearch">
	                    <table summary="all tags table" class="tagsCloud">
	                        <mir:tagsCloud data="${data}">
	                            ${prefix}
	                            <td><input name="tags2search" type="checkbox" value="${tag.id}" />&nbsp;<span style="font-size:${nbOccurr}%;"><a href="mdb?section=metadata&amp;id=${tag.id}" title="Number of occurrences: ${tag.nbOccurrence}">${tag.name}</a></span></td>
	                            ${suffix}
	                        </mir:tagsCloud>
	                    </table>
                    ...
                    <h3>Help</h3>
                    <p>
                        A click on one tag will return the list of data types associated with it.
                    </p>
                    <p>
                        By selecting several tags and using the 'Search' button, you will be able to see the list of data types associated with <b>all</b> the selected tags.
                    </p>
