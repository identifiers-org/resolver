<%--
  ...
  MIRIAM Web Interface,
    ...
    Curation interface: overview of the pending/canceled/published data types 
                ...
                <td class="contentsarea" id="contentsarea">
                    ...
                    <p style="text-align:right;">
	                    <c:choose>
	                        ...
	                        <c:otherwise>
	                            <a href="mdb?section=curation&amp;type=submitted" title="Display only data types in the 'Submitted' state">Submitted</a>
	                        </c:otherwise>
	                    </c:choose>
	                    |
	                    <c:choose>
	                        ...
	                        <c:otherwise>
	                            <a href="mdb?section=curation&amp;type=curation" title="Display only data types in the 'Curation' state">Curation</a>
	                        </c:otherwise>
	                    </c:choose>
	                    |
	                    <c:choose>
	                        ...
	                        <c:otherwise>
	                            <a href="mdb?section=curation&amp;type=published" title="Display only data types in the 'Published' state">Published</a>
	                        </c:otherwise>
	                    </c:choose>
	                    |
	                    <c:choose>
	                        ...
	                        <c:otherwise>
	                            <a href="mdb?section=curation&amp;type=pending" title="Display only data types in the 'Pending' state">Pending</a>
	                        </c:otherwise>
	                    </c:choose>
	                    |
	                    <c:choose>
	                        ...
	                        <c:otherwise>
	                            <a href="mdb?section=curation&amp;type=canceled" title="Display only data types in the 'Canceled' state">Canceled</a>
	                        </c:otherwise>
	                    </c:choose>
	                    |
	                    <c:choose>
	                        ...
	                        <c:otherwise>
	                            <a href="mdb?section=curation&amp;type=all" title="Display all data types">All</a>
	                        </c:otherwise>
	                    </c:choose>
	                </p>
                    
                    <p>
                        Brief overview of the data types:
                    </p>
                        ...
                        <table class="sqlresult" summary="data types overview">
                            ...
                            <mir:curationBrowse data="${data}">
                                <tr class="${class}">
                                    ...
                                    <td class="${class}">
                                        <a href="mdb?section=curation&amp;data=${cura.id}" title="Access to the complete information about the data type: ${cura.name}">${cura.name}</a>
                                    </td>
                                    ...
                                    <td class="${class}">
                                        <c:choose>
							                <%-- the data type is not published yet --%>
							                <c:when test="${cura.state == 'Published'}">
							                    &nbsp;<a href="mdb?section=browse&amp;data=${cura.publicId}" title="Access to the published data type">${cura.publicId}</a>&nbsp;
							                </c:when>
							                <%-- the data type is published --%>
							                <c:otherwise>
							                    <a href="mdb?section=publish&amp;data=${cura.id}" title="Publish data type">Publish it!</a>
							                </c:otherwise>
							            </c:choose>
                                    </td>
                                </tr>
