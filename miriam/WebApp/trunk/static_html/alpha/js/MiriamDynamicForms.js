...
function addSynonym()
{
	...
	newdiv.innerHTML = "\nSynonym:&nbsp;<input type=\"text\" name=\"synonym" + num + "\" size=\"45\" /> &nbsp; <a href=\"javascript:;\" title=\"Remove this synonym\" onclick=\"removeSynonym(\'" + IdName + "')\"><img src=\"http://www.ebi.ac.uk/compneur-srv/miriam/alpha/img/Delete.gif\" alt=\"Delete logo\" height=\"16\" width=\"16\" /></a>\n";
...
function addDeprecated()
{
	...
	var newdiv = document.createElement('div');
	newdiv.setAttribute("id",IdName);
	newdiv.innerHTML = "\nDeprecated URI:&nbsp;<input type=\"text\" name=\"deprecated" + num + "\" size=\"45\" /> &nbsp; <a href=\"javascript:;\" title=\"Remove this deprecated URI\" onclick=\"removeDeprecated(\'" + IdName + "\')\"><img src=\"http://www.ebi.ac.uk/compneur-srv/miriam/alpha/img/Delete.gif\" alt=\"Delete logo\" height=\"16\" width=\"16\" /></a>\n";
...
function generateExampleLink(prefix, suffix, identifier)
{
    ...
    //window.open("http://www.ebi.ac.uk/miriam/", 'open_window', 'menubar, toolbar, location, directories, status, scrollbars, resizable, dependent, width=640, height=480, left=0, top=0');
}
