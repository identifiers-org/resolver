...
function addSynonym()
{
	...
	newdiv.innerHTML = "\nSynonym:&nbsp;<input type=\"text\" name=\"synonym" + num + "\" size=\"45\" /> &nbsp; <a href=\"javascript:;\" title=\"Remove this synonym\" onclick=\"removeSynonym(\'" + IdName + "')\"><img src=\"http://www.ebi.ac.uk/compneur-srv/miriam/main/img/Delete.gif\" alt=\"Delete logo\" height=\"16\" width=\"16\" /></a>\n";
...
function addDeprecated()
{
	...
	var newdiv = document.createElement('div');
	newdiv.setAttribute("id",IdName);
	newdiv.innerHTML = "\nDeprecated URI:&nbsp;<input type=\"text\" name=\"deprecated" + num + "\" size=\"45\" /> &nbsp; <a href=\"javascript:;\" title=\"Remove this deprecated URI\" onclick=\"removeDeprecated(\'" + IdName + "\')\"><img src=\"http://www.ebi.ac.uk/compneur-srv/miriam/main/img/Delete.gif\" alt=\"Delete logo\" height=\"16\" width=\"16\" /></a>\n";
