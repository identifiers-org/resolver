        ...
        <table class="contentspane" id="contentspane" summary="The main content pane of the page" style="width: 100%">
            <tr>
                ...
                <td class="contentsarea" id="contentsarea">
                    ...
                    <h2>Publication requested for: ${data.name}</h2>
                    
                    <p>
                        Do you want to publish the following data type: <b>${data.name}</b> (${data.id})?
                    </p>
                    ...
                    <form method="post" action="publishDataType">
                        ...
                        <input type="reset" value="No" onclick="location.href='mdb?section=curation&amp;type=all'" class="reset_button" />
                    </form>
