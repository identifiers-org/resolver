      ...
      <tr>
        ...
        <td class="contentsarea" id="contentsarea">
          ...
          <h1>MIRIAM</h1>
					...
					<p>
						An email has been sent to the administrator. As no data type can be removed, it (they) will become 'obsolete'. Thank you for your support.
					</p>
