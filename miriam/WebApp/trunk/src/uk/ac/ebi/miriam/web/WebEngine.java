...
public class WebEngine extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
{
    ...
    private enum sections {intro, browse, search, metadata, request, submit, standard, news, faq, contact, export, ws, edit, qualifiers, ws_help, media, docs, annotation, tags, support, edit_tag, edit_anno, stats, signin, user, edit_tags, curation, publish, users};
