<%--
  ...
  Tags management page: displays all the tags and allow their edition
                ...
                <td class="contentsarea" id="contentsarea">
                    ...
                    <ul>
                        <c:forEach var="tag" items="${tags}">
                            <li><a href="javascript://nop/" title="Display this tag details" class="ajaxLink" name="${tag.id}" id="${tag.id}">${tag.name}</a></li>
                        </c:forEach>
                    </ul>
                    
                    <br />
                    <p>
                        ${counter} tag<c:if test="${counter > 1}">s</c:if> stored.
                    </p>
